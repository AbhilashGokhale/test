                ...
                <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="bFxiTCZlDCwpq51NC/4QZILJYE+AUrImIYUxCKVSfrdyxTNEMZK5Jmh+CRa9AhcKWsOVBWHZwiKzktIlHon5v7DPaWsjCWhOT8wIbpiRu8ET+J7fM3aWm2o2bB6CUGpz">
                    ...
                    <div class="dragArea row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          <div></div><h1 class="mbr-section-title mb-4 display-2">
                                <strong>Catch Us</strong>
                            </h1>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="col-lg-12 col-md col-sm-12 form-group mb-3">
                            <a href="https://forms.gle/cvWDnsoN8faiuTFWA" id="email-form3-u" target="_blank">Click here</a> to upload your CV/Resume
                      </div>                      
        ...
        <input type="submit"/>
            ...
            <div class="col-lg-7 col-12">
                <div class="image-wrapper">
                    <img class="w-100" src="assets/images/wok with us llp.jpeg" alt="Mobirise">
                </div>
            </div>
